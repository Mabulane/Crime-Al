    ...
    const pass= signUp['user-password'].value;
      ...
      //phone name
            ...
            */
              ...
              document.getElementById("verifyContact").innerHTML=`<p></p>`;
             // var newTime =posteddate.getHours() +':'+posteddate.getMinutes() +':'+ posteddate.getSeconds()+'s';
              //var newDate =posteddate.getDate()+'/'+ month+'/'+ posteddate.getFullYear();
                    ...
                    auth.createUserWithEmailAndPassword(email,pass).then(cred=>{
                      // console.log(cred.user);
                        ...
                        newDate =dateT.getDate()+'/'+ month+'/'+ dateT.getFullYear();
